...
-- -----------------------------------------------------
-- Table `LePrAtos_DB`.`Users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LePrAtos_DB`.`Users` (
  `ID_User` VARCHAR(20) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `LePrAtos_DB`.`Participants` (
  ...
  CONSTRAINT `fk_Participants_User`
    FOREIGN KEY (`FK_User`)
    REFERENCES `LePrAtos_DB`.`Users` (`ID_User`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `LePrAtos_DB`.`Buildings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LePrAtos_DB`.`Buildings` (
  `ID_Card` VARCHAR(5) NOT NULL COMMENT '',
  `Amount` INT NOT NULL COMMENT '',
  PRIMARY KEY (`ID_Card`)  COMMENT '')
ENGINE = InnoDB;
